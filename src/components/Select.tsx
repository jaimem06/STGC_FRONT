        ...
        <div className="relative group">
          ...
          <RadixSelect.Portal>
            <RadixSelect.Content 
              ...
              sideOffset={5}
            >
              <RadixSelect.ScrollUpButton className="flex items-center justify-center h-[25px] bg-white text-primary cursor-default">
              ...
              <RadixSelect.ScrollDownButton className="flex items-center justify-center h-[25px] bg-white text-primary cursor-default">
                <ChevronDown size={14} />
