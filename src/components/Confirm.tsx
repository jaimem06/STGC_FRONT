          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex gap-4 w-full justify-center">
              <AlertDialogPrimitive.Cancel asChild>
                <button className={`flex-1 px-6 py-4 rounded-2xl border border-outline-variant/30 font-headline font-bold text-xs hover:bg-surface-container transition-all active:scale-95 ${variant === 'success' ? 'bg-secondary text-white border-transparent' : 'text-outline'}`}>
                  {variant === "success" ? "ENTENDIDO" : "CANCELAR"}
                </button>
